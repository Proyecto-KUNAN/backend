...
export default function Form({ onSubmit = (data, isValid, event) => {}, initialData = { name: '', lastName: '', email: '', phone: '', web: '', industry: 0, ventaIndirencta: false, consulta: '' }, disabledInput = { name: false, lastName: false, email: false, phone: false, web: false, industry: false, ventaIndirencta: false, consulta: false } }) {
    ...
    <form className='row gap-4 p-4' onSubmit={handlerSubmit}>
      ...
      <div className='row justify-content-start ms-3 m-0 p-0'>
        <div className='form-check col'>
          <input className='form-check-input' type='checkbox' value='' id='flexCheckDefault' onChange={(e) => setVentaIndirencta(e.target.value)} defaultValue={initialData.ventaIndirencta} disabled={disabledInput.ventaIndirencta} />
